...
#custom append
_C.ENVIRONMENT = CN()
_C.ENVIRONMENT.MAPSCALE = 0.03
_C.ENVIRONMENT.CHANGE_FREQ = 25
_C.ENVIRONMENT.LOCAL_GOAL_DIST = 0.5
_C.ENVIRONMENT.LOCAL_GOAL_SUCCESS_DIST = 0.05

#AGENT
_C.AGENT = CN()
_C.AGENT.GOAL_SENSOR_UUID =  "pointgoal_with_gps_compass"
_C.AGENT.INPUT_TYPE = "blind"
_C.AGENT.HIDDEN_SIZE = 512
_C.AGENT.RANDOM_SEED = 7
_C.AGENT.MODEL_PATH =  "data/checkpoints/blind.pth"
_C.AGENT.RESOLUTION = 256
_C.AGENT.PTH_GPU_ID = 0
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
_C.ORBSLAM2 = CN()
_C.ORBSLAM2.SLAM_VOCAB_PATH = "slambased/data/ORBvoc.txt"
