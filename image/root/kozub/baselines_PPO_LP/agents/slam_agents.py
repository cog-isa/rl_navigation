...
from slambased.mappers import DirectDepthMapper
from slambased.monodepth import MonoDepthEstimator
from slambased.path_planners import DifferentiableStarPlanner
from slambased.reprojection import (
...
from slambased.utils import generate_2dgrid
...
class ORBSLAM2MonodepthAgent(ORBSLAM2Agent):
    def __init__(
        ...
        monocheckpoint="/slambased/data/mp3d_resnet50.pth",
    ):
        self.num_actions = config.NUM_ACTIONS
        self.dist_threshold_to_stop = config.DIST_TO_STOP
        self.slam_vocab_path = config.SLAM_VOCAB_PATH
