...
@baseline_registry.register_env(name="Exploration_Env")
class Exploration_Env(habitat.RLEnv):
    ...
    def reset(self):
        ...
        self.info = {
            ...
            'semantic_fp_proj': semantic_fp_proj,
            'sensor_pose': [0., 0., 0.],
            'pose_err': [0., 0., 0.],
        }
    ...
    def step(self, action):
     ...
     #   else:
        ...
        self.info['semantic_fp_proj'] = semantic_fp_proj
        ...
        return state, rew, done, self.info, obs, info
    ...
    def get_short_term_goal(self, inputs):
        ...
        sem_pred = inputs['sem_pred']

        grid = np.rint(map_pred)
        explored = np.rint(exp_pred)
        semantic = np.rint(sem_pred)
        ...
        # Get short-term goal
        stg = self._get_stg(grid, explored, semantic, start, np.copy(goal), planning_window)
    ...
    def _get_stg(self, grid, explored, semantic, start, goal, planning_window):
