...
from utils.common_utils import CategoricalNet, Flatten
...
class PointNavResNetPolicy(Policy):
    def __init__(
        ...
        observation_space,
        action_space,
        goal_sensor_uuid="pos",#"pointgoal_with_gps_compass",
        hidden_size=512,
...
class ResNetEncoder(nn.Module):
   ...
   #         cnn_input.append(rgb_observations)
        ...
        if self._n_input_depth > 0:
            ...
            depth_observations = depth_observations.unsqueeze(3).permute(0, 3, 1, 2)
