...
class DDPPOTrainer(PPOTrainer):
    ...
    def _setup_actor_critic_agent(self, ppo_cfg: Config) -> None:
        ...
        self.actor_critic = PointNavResNetPolicy(
            observation_space=self.obs_space,#envs.observation_spaces[0],
            ...
            normalize_visual_inputs=False#"rgb" in self.envs.observation_spaces[0].spaces,
        )
    ...
    def train(self) -> None:
        ...
        obs_space = self.obs_space#self.envs.observation_spaces[0]
