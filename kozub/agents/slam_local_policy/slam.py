...
class DepthMapperAndPlanner(object):
  ...
  def act(self, observations, step_num, lp =  False):
    if self.RESET:
      self.RESET = False
      return self._act(step_num, observations, True, lp)
    else:
      return self._act(step_num, observations, False, lp)
  
  def _act(self, i, obs, done, lp):
    ...
    #---------kozub-----------
    if lp:
      return act, relative_local, drift
    else:
      return act, drift
    #instead:
      #return act
